...
public final class RandomTeamListProvider extends TeamListProvider {
    public static final MapCodec<RandomTeamListProvider> CODEC = TeamListProvider.TYPE_CODEC.listOf().fieldOf("providers").xmap(RandomTeamListProvider::new, RandomTeamListProvider::providers);
